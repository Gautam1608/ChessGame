...
public class ChessGUI {
    ...
    public class BoardPanel extends JPanel {
        ...
        public boolean promoteNCheckCheckMate(Component dragComponent, Point end) {
            remove(dragComponent);
            Scanner sc = new Scanner(System.in);
            System.out.print("Letter of the piece you want : ");
            ...
            piece.setIcon(new ImageIcon(chessArt.getSubimage(imageD * x, imageD * y, imageD, imageD).getScaledInstance(64, 64, BufferedImage.SCALE_SMOOTH)));
            add(piece, end);
            return ChessLogic.updatePromotion(newPiece);
        }
        ...
        public void pieceMovement(Component dragComponent, Point start, Point end) {
            ...
            try {
                ...
                if (moveType[3]) {
                    moveType[4] = promoteNCheckCheckMate(dragComponent, end);
                }
                if (moveType[4]) {
